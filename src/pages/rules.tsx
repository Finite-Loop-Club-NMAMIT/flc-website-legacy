    ...
    return (
      <div className="px-10 pb-10">
        ...
        <div className="flex gap-3 flex-col">
          <p className="text-md md:text-lg font-bold">Terms & Conditions</p>
          ...
          <div className="text-sm md:text-lg">
            ...
            <p>
              ...
              privacy policy govern INSPIRANTE TECHNOLOGIES PRIVATE LIMITED&apos;s
              relationship with you in relation to this website.
            </p>
            <p>
              The term &apos;INSPIRANTE TECHNOLOGIES PRIVATE LIMITED&apos; or
              &apos;us&apos; or &apos;we&apos; refers to the owner of the website
              whose registered/operational office is 2-1-22, Bombay House, ,
              Kalsanka, Kunjibettu P O Udupi KARNATAKA 576102. The term
            ...
            <ul className="list-disc px-2 md:px-10">
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  or document without INSPIRANTE TECHNOLOGIES PRIVATE LIMITED’s
