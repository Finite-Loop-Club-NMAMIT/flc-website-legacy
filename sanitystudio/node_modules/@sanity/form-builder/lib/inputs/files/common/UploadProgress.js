...
function UploadProgress(_ref) {
  var _uploadState$file$nam, _uploadState$file;

  var uploadState = _ref.uploadState,
      onCancel = _ref.onCancel,
      onStale = _ref.onStale,
      height = _ref.height;
  var filename = (_uploadState$file$nam = (_uploadState$file = uploadState.file) === null || _uploadState$file === void 0 ? void 0 : _uploadState$file.name) !== null && _uploadState$file$nam !== void 0 ? _uploadState$file$nam : '...';
  (0, _react.useEffect)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_UploadProgress.CardWrapper, {
    ...
    size: 1
  }, filename)))), /*#__PURE__*/_react.default.createElement(_ui.Card, {
    marginTop: 3,
    radius: 5,
    shadow: 1
