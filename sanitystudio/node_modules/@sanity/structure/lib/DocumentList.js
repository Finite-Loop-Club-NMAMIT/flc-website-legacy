...
var resolveDocumentChildForItem = (itemId, options) => {
  ...
  var template = (_options$params = options.params) !== null && _options$params !== void 0 && _options$params.template ? (0, _initialValueTemplates.getTemplateById)(options.params.template) : undefined;
  var type = template ? template.schemaType : parentItem.schemaTypeName || resolveTypeForDocument(itemId);
