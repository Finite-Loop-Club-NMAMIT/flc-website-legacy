...
var Navbar = /*#__PURE__*/(0, _react.memo)(function Navbar(props) {
  var createMenuIsOpen = props.createMenuIsOpen,
      ...
      setCreateButtonElement = props.setCreateButtonElement,
  ...
  var noDocumentOptions = (newDocumentOptions === null || newDocumentOptions === void 0 ? void 0 : newDocumentOptions.length) === 0;
  ...
  var createTooltipContent = (0, _react.useMemo)(() => {
    if (noDocumentOptions) {
      return /*#__PURE__*/_react.default.createElement(_ui.Text, {
        size: 1
      }, "You need a schema to create a new document");
    }
    ...
    return /*#__PURE__*/_react.default.createElement(_components.InsufficientPermissionsMessage, {
      currentUser: currentUser,
      operationLabel: "create any document"
    });
  }, [canCreateSome, currentUser, noDocumentOptions]); // The HTML elements that are part of the search view (i.e. the "close" button that is visible
