 ...
 */
export declare function ConfirmDeleteDialogBody({ crossDatasetReferences, internalReferences, documentTitle, totalCount, action, projectIds, onReferenceLinkClick, }: DeletionConfirmationDialogBodyProps): JSX.Element;
export {};
