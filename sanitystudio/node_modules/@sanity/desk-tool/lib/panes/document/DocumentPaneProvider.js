...
var _useReferringDocuments = require("../../components/confirmDeleteDialog/useReferringDocuments");
...
var DocumentPaneProvider = /*#__PURE__*/(0, _react.memo)(_ref => {
  ...
  var _useReferringDocument = (0, _useReferringDocuments.useReferringDocuments)(options.id, {
    externalPollInterval: 1000 * 60
  }),
      totalCount = _useReferringDocument.totalCount,
      isReferencesLoading = _useReferringDocument.isLoading;

  var totalReferenceCount = isReferencesLoading ? undefined : totalCount;
