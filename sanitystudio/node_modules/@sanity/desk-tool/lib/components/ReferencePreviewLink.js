...
exports.ReferencePreviewLink = ReferencePreviewLink;
...
var _PaneItemPreview = require("./paneItem/PaneItemPreview");
...
function ReferencePreviewLink(props) {
  var onClick = props.onClick,
      type = props.type,
      value = props.value;
  var publishedId = (0, _draftUtils.getPublishedId)(value === null || value === void 0 ? void 0 : value._id);
  var documentPresence = (0, _hooks.useDocumentPresence)(publishedId);

  var _usePaneRouter = (0, _paneRouter.usePaneRouter)(),
      ReferenceChildLink = _usePaneRouter.ReferenceChildLink;

  var Link = (0, _react.useCallback)(linkProps => /*#__PURE__*/_react.default.createElement(ReferenceChildLink, _extends({
  ...
  return /*#__PURE__*/_react.default.createElement(_components.PreviewCard, {
    ...
    padding: 2,
    radius: 2
  }, /*#__PURE__*/_react.default.createElement(_PaneItemPreview.PaneItemPreview, {
