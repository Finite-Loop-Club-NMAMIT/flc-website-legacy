...
function canHandleIntent(intentName, params) {
  return Boolean(intentName === 'edit' && params.id || intentName === 'create' && params.type || intentName === 'create' && params.template || intentName === 'open-tool' && params.tool === 'desk');
}
...
function DeskToolRoot() {
  ...
  var openIndex = intent && intent === 'open-tool';
  (0, _react.useEffect)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_ui.ErrorBoundary, {
    onCatch: handleCatch
  }, intent && !openIndex ? /*#__PURE__*/_react.default.createElement(_intentResolver.IntentResolver, {
    intent: intent,
    params: params,
    payload: payload
