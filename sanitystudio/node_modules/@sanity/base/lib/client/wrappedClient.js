...
var wrappedClient = {
  ...
  withConfig: newConfig => {
    ...
    instances.push(newClient); // Subscribe to auth token stream and configure the client depending on token value unless the client was originally configured with a token.

    var preconfiguredToken = Boolean(configuredClient.config().token);
