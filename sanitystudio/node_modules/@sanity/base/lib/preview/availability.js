...
function chunkDocumentIds(documentIds) {
  ...
  var _iterator = _createForOfIteratorHelper(documentIds),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var documentId = _step.value;
...
var fetchDocumentReadability = (0, _debounceCollect.debounceCollect)(function fetchDocumentReadability(args) {
  ...
  return (0, _rxjs.from)(chunkDocumentIds(uniqueIds)).pipe((0, _operators.mergeMap)(fetchDocumentReadabilityChunked, 10), (0, _operators.map)(res => args.map(_ref3 => {
