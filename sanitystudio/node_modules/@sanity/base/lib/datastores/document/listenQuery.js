...
var fetch = (query, params, options) => (0, _rxjs.defer)(() => (0, _versionedClient.getVersionedClient)(options.apiVersion).observable.fetch(query, params, {
  tag: options.tag,
  filterResponse: true
}));

var listen = (query, params, options) => (0, _rxjs.defer)(() => (0, _versionedClient.getVersionedClient)(options.apiVersion).listen(query, params, {
...
var listenQuery = function listenQuery(query) {
  ...
  var fetchQuery = typeof query === 'string' ? query : query.fetch;
  var listenerQuery = typeof query === 'string' ? query : query.listen;
  var fetchOnce$ = fetch(fetchQuery, params, options);
  var events$ = listen(listenerQuery, params, options).pipe((0, _operators.mergeMap)((ev, i) => {
    var isFirst = i === 0;
