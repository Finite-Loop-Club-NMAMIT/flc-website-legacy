  ...
  return (
    <div className="px-10 pb-10">
      ...
      <div className="flex gap-3 flex-col">
        ...
        <p>
          INSPIRANTE TECHNOLOGIES PRIVATE LIMITED believes in helping its
          customers as far as possible, and has therefore a liberal cancellation
          policy. Under this policy:
        </p>
        <ul className="list-disc px-0 md:px-10 text-sm md:text-lg">
          <li>
          ...
          <li>
            INSPIRANTE TECHNOLOGIES PRIVATE LIMITED does not accept cancellation
          ...
          <li>
            In case of any Refunds approved by the INSPIRANTE TECHNOLOGIES
            PRIVATE LIMITED, it&apos;ll take 1-2 days for the refund to be
